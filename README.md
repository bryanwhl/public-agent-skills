...
Researches an unfamiliar topic from first principles and produces a concise, source-grounded, interactive HTML learning deck. The deck uses expandable explanations and clickable jargon definitions, and is saved under `~/Projects/personal` by default.
